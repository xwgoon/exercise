package com.horstmann.corejava.v2ch09.rsa;
...
//      args = new String[]{"-genkey", "public.key", "private.key"};//generate key
//        args = new String[]{"-encrypt", "plaintext.txt", "encrypted.bat", "public.key"};//encrypt
        args = new String[]{"-decrypt", "encrypted.bat", "decrypted.txt",  "private.key"};//decrypt
