...
//         path = Paths.get("transform", "makehtml.xsl");
      path = Paths.get("src\\main\\java\\com\\horstmann\\corejava\\v2ch03\\transform", "makeprop.xsl");
      try (InputStream styleIn = Files.newInputStream(path))
      {
         ...
         try (InputStream docIn = Files.newInputStream(Paths.get("src\\main\\java\\com\\horstmann\\corejava\\v2ch03\\transform", "employee.dat")))
         {
