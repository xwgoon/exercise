...
//    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        PublicKey publicKey = ac.getPublic(outFile+"public.key");
        PrivateKey privateKey = ac.getPrivate(outFile+"private.key");
...
//        String decrypted_msg = ac.decryptText(encrypted_msg, publicKey);
        ...
        if (new File(outFile+"text.txt").exists()) {
            ac.encryptFile(ac.getFileInBytes(new File(outFile+"text.txt")),
                    new File(outFile+"text_encrypted.txt"), privateKey);
            ac.decryptFile(ac.getFileInBytes(new File(outFile+"text_encrypted.txt")),
                    new File(outFile+"text_decrypted.txt"), publicKey);
        } else {
